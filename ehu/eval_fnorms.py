...
def main():
    os.environ["EMBEDDING_EVALUATION_DATA_PATH"] = "/tartalo03/users/muster/embedding_evaluation_paper/src/EloiZ/data"
    ...
    total_results = {}
    eval_object = EvaluationFeatureNorm() # use EloiZ to evaluate embeddings
    ...
    for emb_name, r in total_results.items():
        ...
        print("| {} | {:.2f} : {:.2f} |".format(emb_name, r['macro'], coverage))

if __name__ == '__main__':
    warnings.filterwarnings(message='^F-score is ill-defined', action='ignore')
    main()
